##########################################################################################################################
## Title: Positive-unlabeled learning of meta-path based functional profiles for predicting drug-disease associations
## Authors: Thitipong Kawichai, Apichat Suratanee, and Kitiporn Plaimas

## Program Name: PUMDR-demo.py
## Program Description: - This program is to demonstrate how PUMDR works by using smaller data sets than those original ones.
...
## Output:
## Selected PUMDR compartments: - Concatenate the profile matrices of M1, M2, and M3
...
def PUMDR(drug_go_matrix, disease_go_matrix, drug_disease_matrix, drug_list, disease_list, function_list, latent_feature_percent, T, xgboost_params):
    ...
    #####################################################################################################################################################    
    # Step 3: Train PUMDR and predict all unlabeled drug-disease pairs
    ##################################################################################################################################################### 
    
    print("Step 3: Train PUMDR model and predict all unlabeled drug-disease pairs to identify the potential ones") 
...
if __name__ == "__main__":
    ...
    print("")
    print("================================================================================")
    print("Demo version of Positive-Unlabeled learning of Meta-path based functional Profiles (PUMDR)")
    print("================================================================================")
    print("")
    
    # Set values to PUMDR parameters
    ...
    PUMDR(drug_go_matrix, disease_go_matrix, drug_disease_matrix, drug_list, disease_list, function_list, latent_feature_percent, T, xgboost_params)
